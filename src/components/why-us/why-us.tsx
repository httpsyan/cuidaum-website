  ...
  return (
    <section className="container px-4 mx-auto">
      <div className="flex flex-col items-center justify-center text-center">
        ...
        <p className="font-bold text-3xl md:text-4xl text-[#0D2056] max-w-4xl mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16">
          ...
          <article className="flex flex-col items-center space-y-6">
            ...
            <p className="text-[#72727B] text-base max-w-xs">
              Interação direta com profissionais de saúde para ajustes nas
              rotinas e feedback contínuo.
            </p>
          </article>
